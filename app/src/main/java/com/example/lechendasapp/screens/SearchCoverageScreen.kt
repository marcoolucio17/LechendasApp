    ...
    Card(
        ...
        AnimatedVisibility(
            ...
            Column(
                ...
                DetailItem("Tracking", log.tracking)
                DetailItem("Change", log.change)
                DetailItem("Coverage", log.coverage)
                DetailItem("Crop Type", log.cropType)
                DetailItem("Disturbance", log.disturbance)
